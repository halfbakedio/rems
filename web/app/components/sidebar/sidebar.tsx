    ...
    <>
      ...
      <Sidenav open={open} toggle={toggle}>
        <SidenavItem href="#">
          ...
          <span className="pl-2 text-sm">User Config</span>
        </SidenavItem>
        <SidenavItem href="#">
          <svg
            stroke="currentColor"
          ...
          <span className="pl-2 text-sm">Posts</span>
        </SidenavItem>
        <SidenavItem href="#">
          <svg
            stroke="currentColor"
          ...
          <span className="pl-2 text-sm">Likes</span>
        </SidenavItem>
        <SidenavItem href="#">
          <svg
            stroke="currentColor"
          ...
          <span className="pl-2 text-sm">Comments</span>
        </SidenavItem>
      </Sidenav>
    </>
  );
